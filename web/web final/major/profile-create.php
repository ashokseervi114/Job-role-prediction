...
// Getting the users Table Primary Key which is foreign in users_detail Table. 
	...
	if(isset($_POST['saveUsersDetails'])) {
		...
		// No need of this create else method in create. Already checking for values as profile page and redirecting update and create there.
